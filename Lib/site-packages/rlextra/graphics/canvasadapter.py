...
class CanvasAdapter:
    def __init__(self,baseCanvas,trans={},baseRenderer=None,**kw):
        self.__trans = trans #PDF canvas attribute --> PM/SVG/PS attribute
        self.__rtrans = kw.pop('rtrans',{}) #PM/SVG/PS attribute --> PDF canvas
