...
<!ATTLIST document
    ...
    tagged (yes | no | 0 | 1 | true | false ) #IMPLIED
    debug (0 | 1) #IMPLIED
	...
	encryptionStrength (256|128|40) #IMPLIED 
>
...
<!ATTLIST pageInfo
	...
	hideToolbar (yes | no | 0 | 1 | true | false | none) "none"
	hideMenubar (yes | no | 0 | 1 | true | false | none) "none"
	hideWindowUI (yes | no | 0 | 1 | true | false | none) "none"
	fitWindow (yes | no | 0 | 1 | true | false | none) "none"
	centerWindow (yes | no | 0 | 1 | true | false | none) "none"
	nonFullScreenPageMode (UseNone | UseOutlines | UseThumbs | UseOC) #IMPLIED
	direction (L2R | R2L) #IMPLIED
	viewArea (MediaBox | CropBox | BleedBox | TrimBox | ArtBox) #IMPLIED
	viewClip (MediaBox | CropBox | BleedBox | TrimBox | ArtBox) #IMPLIED
	printArea (MediaBox | CropBox | BleedBox | TrimBox | ArtBox) #IMPLIED
	printClip (MediaBox | CropBox | BleedBox | TrimBox | ArtBox) #IMPLIED
	printScaling (None | AppDefault) #IMPLIED
	duplex (Simplex | DuplexFlipShortEdge | DuplexFlipLongEdge) #IMPLIED
	lang CDATA #IMPLIED
...
effect and consumes no space. If new is true (default false) the
value is assigned only if the namedString is currently undefined.
If discard is true (default false) then the result is evaluated
and assigned early and the result is discarded

If indexName is set it is assumed to be the name of another namedString
whose value is to be used as an index; this namedString will then become
a dict of stringS rather than a simple string.
...
<!ATTLIST namedString
    ...
    new (yes | no | 0 | 1 | none) #IMPLIED
    discard (yes | no | 0 | 1 | none) #IMPLIED
...
<!ATTLIST param
    name CDATA #REQUIRED
>
<!-- this yanks information from 'name' which must be a dict if
indexName (the name of another namedString) is used-->
...
<!ENTITY % DRAWINGOPS "(saveState | restoreState
    ...
    | circle | rect | fill | stroke | overprint | blendMode | setFont | setFontSize | image 
    | pageGraphics | place | placePara | placeXPre | form | doForm | plugInGraphic
    | scale | translate | rotate | skew | transform
    | grid | path | lines | curves | lineMode 
    | textBox | barCode | checkBox | letterBoxes | textAnnotation | highlightAnnotation
	| textField | checkboxField | radioField | choiceField | listboxField | drawingGraphic
    | drawIf | markedContent | crossMark | digitalSignature %LOGIC_GRAPHICS;)*">
...
<!ATTLIST image
	...
	anchorAtXY (yes | no | 0 | 1 | true | false) "false"
	tagType CDATA #IMPLIED
	altText CDATA #IMPLIED
>
...
<!ELEMENT blendMode EMPTY>
<!ATTLIST blendMode
    mode ( Normal | MultiPly | Screen | Overlay | Darken | Lighten | 
		  ColorDodge | ColorBurn | HardLight | SoftLight | Difference |
		  Exclusion | Hue | Saturation | Color | Luminosity ) #REQUIRED
>
...
pitch			USPS_4State restricted pitch setter
...
color			these are all for the DataMatrix
cellSize
size
encoding
anchor
...
|Standard39|Standard93|UPCA|USPS_4State|DataMatrix)"
>
<!ENTITY % BARCODE_ATTRS "
	...
	size (RectAuto | SquareAuto | ShapeAuto | 10x10 | 12x12 | 14x14 | 16x16 | 18x18 | 20x20 | 22x22 | 24x24 | 26x26 | 32x32 | 36x36 | 40x40 | 44x44 | 48x48 | 52x52 | 64x64 | 72x72 | 80x80 | 88x88 | 96x96 | 104x104 | 120x120 | 132x132 | 144x144 | 8x18 | 8x32 | 12x26 | 12x36 | 16x36 | 16x48) #IMPLIED
	encoding (Ascii | AutoBest | AutoFast | Base256 | C40 | Edifact | Text | X12) #IMPLIED
	anchor (n|ne|e|se|s|sw|w|nw|c) #IMPLIED
...
<!ATTLIST drawing
	%DRAWING_ATTRS;
>
<!ELEMENT drawingGraphic (caption?, (param | widget)*)>
<!ATTLIST drawingGraphic
    x CDATA #REQUIRED
    y CDATA #REQUIRED
	anchor (
		nw  | n  | ne  |
...
-->
<!ENTITY % DRAWSTRING_ATTRS "
    x CDATA #REQUIRED
    y CDATA #REQUIRED
	mode CDATA #IMPLIED
	charSpace CDATA #IMPLIED
	direction (ltr | LTR | rtl | RTL | none) #IMPLIED
    tagType CDATA #IMPLIED
	altText CDATA #IMPLIED"
	>
...
<!ENTITY % PLACESTRING_ATTRS   "%DRAWSTRING_ATTRS;
...
<!ENTITY % _TEXT_ANNOTATION_ATTRS "
    rect CDATA #IMPLIED
    quadpoints CDATA #IMPLIED
	color CDATA #IMPLIED
    relative (yes | no | 0 | 1 ) #IMPLIED
    addToPage (yes | no | 0 | 1 ) #IMPLIED
	name CDATA #IMPLIED
">
<!ATTLIST textAnnotation
	%_TEXT_ANNOTATION_ATTRS;
>
<!ELEMENT highlightAnnotation (#PCDATA | param)*>
<!ATTLIST highlightAnnotation
	%_TEXT_ANNOTATION_ATTRS;
>
...
<!ELEMENT blockTableStyle (blockSpan | blockFont | blockLeading | blockTextColor | blockAlignment | blockLeftPadding | blockRightPadding | blockBottomPadding | blockTopPadding | blockBackground | blockValign | lineStyle | roundedCorners)*>
...
<!--
	...
	else rounding radii top left, top right, bottom left, bottom right
	radii <= 0 are square
-->
<!ELEMENT roundedCorners EMPTY>
<!ATTLIST roundedCorners
    radii CDATA #IMPLIED
>
<!--borderPadding can be a singleton or (t,r) or (t,r,b) or (t,r,b,l)-->
<!ENTITY % PARA_ATTRS "
	alignment CDATA #IMPLIED
	...
	embeddedHyphenation (yes | no | 0 | 1 | true | false) #IMPLIED
	...
	hyphenationLang CDATA #IMPLIED
	hyphenationMinWordLength CDATA #IMPLIED
	...
	strikeColor CDATA #IMPLIED
	strikeOffset CDATA #IMPLIED
	strikeWidth CDATA #IMPLIED
    tagType CDATA #IMPLIED
	altText CDATA #IMPLIED
	textColor CDATA #IMPLIED
	...
	underlineWidth CDATA #IMPLIED
	uriWasteReduce CDATA #IMPLIED
...
<!ATTLIST paraStyle
	...
	linkUnderline (yes | no | 0 | 1 | true | false) #IMPLIED
>
...
<!ATTLIST boxStyle
    ...
    borderSpec CDATA #IMPLIED
>
<!ENTITY % PARATAGS "para | p | title | h1 | h2 | h3 | h4 | h5 | h6 | pre | xpre">
<!ENTITY % GENERICFLOWABLES "%PARATAGS; | blockTable | spacer | ul | ol | dl
        | illustration | graphicsMode | storyPlace | codesnippet | plugInFlowable | drawing | outlineAdd | namedString
		...
		| placePara | placeXPre | setTopFlowables | setPageTopFlowables | balancedColumns | markedContent
		%LOGIC_BLOCK;">
...
<!ATTLIST indent
    ...
    right CDATA #IMPLIED
>
<!ELEMENT markedContent EMPTY>
<!ATTLIST markedContent
    tagType CDATA #REQUIRED
    text CDATA #IMPLIED
	kind (startGroup | endGroup | start | end) #REQUIRED
>

<!ELEMENT crossMark EMPTY>
<!ATTLIST crossMark
    x CDATA #REQUIRED
    y CDATA #REQUIRED
    size CDATA #IMPLIED
...
<!ATTLIST frameBackground
	...
	borderColor CDATA #IMPLIED
	borderWidth CDATA #IMPLIED
	start (yes | no | 0 | 1 | true | false | frame | frame-permanent) #IMPLIED
>
...
<!ATTLIST imageAndFlowables
    ...
    autoSize (yes | no | 0 | 1 | true | false) "true"
>
<!ELEMENT imageFigure ((para|p)?,inlineData?)>
<!ATTLIST imageFigure
    imageName CDATA #REQUIRED
    imageWidth CDATA #IMPLIED
    imageHeight CDATA #IMPLIED
...
<!ATTLIST balancedColumns
	...
	boxStrokeColor CDATA #IMPLIED
	boxStrokeWidth CDATA #IMPLIED
	boxFillColor CDATA #IMPLIED
	boxMargin CDATA #IMPLIED
	vLinesStrokeColor CDATA #IMPLIED
	vLinesStrokeWidth CDATA #IMPLIED
>
<!ENTITY % PARASTUFF "(#PCDATA | b | a | u | greek | font | span | sup | super | sub | br | strike
            ...
            | name | getName | i | bullet | unichar | link | setLink | onDraw | nobr %LOGIC_INLINE;
            )*">
<!--
...
-->
<!ELEMENT includePdfPages (inlineData?)>
...
<!ELEMENT ul ((%PARATAGS;)?,li*)>
<!ATTLIST ul
	start	CDATA	#IMPLIED
	%LIST_MAIN_ATTRS;
    >
<!ELEMENT ol ((%PARATAGS;)?,li*)>
<!ATTLIST ol
	start	CDATA	#IMPLIED
	%LIST_MAIN_ATTRS;
    >
...
<!ENTITY % LINK_ATTRS "
    ...
    underline (yes | no | 0 | 1 | none) #IMPLIED
	underlineWidth CDATA #IMPLIED
	underlineColor CDATA #IMPLIED
	underlineOffset CDATA #IMPLIED
	uwidth CDATA #IMPLIED
	ucolor CDATA #IMPLIED
	uoffset CDATA #IMPLIED
	ukind CDATA #IMPLIED
	ugap CDATA #IMPLIED"
	>
<!ATTLIST a
...
<!ATTLIST blockTable
	...
	emptyTableAction (error|indicate|ignore) #IMPLIED
	minRowHeights CDATA #IMPLIED
    tagType CDATA #IMPLIED
	altText CDATA #IMPLIED
>
<!-- *NB* repeatRows can be a list  eg (1,) to only repeat the second row of
	 ...
	 the height will override height in the blockTable tag
-->
<!ELEMENT tr (td+)>
<!ATTLIST tr
...
from https://www.w3.org/2003/entities/2007/htmlmathml-f.ent
...
<!--
For this to work you need an smime enabled cert+key+caCert(s) or p12 containing an smime
enabled cert.  The password is either for the p12 or the key.
If the p12 an cert+key are given the p12 is used.
The signing date is generated automatically if not given.
-->
<!ATTLIST digitalSignature
	...
	cert	CDATA #IMPLIED
	caCert1	CDATA #IMPLIED
	caCert2	CDATA #IMPLIED
	caCert3	CDATA #IMPLIED
	caCert4	CDATA #IMPLIED
	location CDATA #IMPLIED
	reason CDATA #IMPLIED
	contact CDATA #IMPLIED
	signingdate CDATA #IMPLIED
	x CDATA #IMPLIED
	y CDATA #IMPLIED
	width CDATA #IMPLIED
	height CDATA #IMPLIED
