...
'''
__version__='3.3.0'
import sys, string, os, random, struct, time
from rlextra.utils.unifunc import unifunc
try:
	import cgi, cgitb
except ImportError:
	try:
		from rlCgi import cgi, cgitb
	except ImportError as _e:
		raise ImportError('''Cannot import cgi & cgitb from rlCgi
perhaps you need to nstall it using
pip install -ihttps://www.reportlab.com/pypi rlCgi''')
